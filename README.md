...
## Version 0.0.2-dev.1
This version is a development version of version 0.0.2. Due to its extensive experimental code, it's unstable and may even contain bugs. Therefore, it's not recommended to use this version unless you want to.


see what's new: [version.md](https://github.com/araxnoid-code/pzeudo/blob/0.0.2-dev.1/version.md)
...
to see the development progress: [0.0.2-dev.1.md](https://github.com/araxnoid-code/pzeudo/blob/0.0.2-dev.1/0.0.2-dev.1.md)
